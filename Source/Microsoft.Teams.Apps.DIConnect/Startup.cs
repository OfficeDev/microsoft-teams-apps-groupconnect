...
#pragma warning restore SA1201 // Declare property before initializing in constructor.
        ...
        private void GetKeyVaultByManagedServiceIdentity()
        {
            ...
            this.Configuration["QnAMakerHostUrl"] = client.GetSecret("QnAMakerHostUrl--SecretKey").Value.Value;
            this.Configuration["QnAMakerApiEndpointUrl"] = client.GetSecret("QnAMakerApiEndpointUrl--SecretKey").Value.Value;

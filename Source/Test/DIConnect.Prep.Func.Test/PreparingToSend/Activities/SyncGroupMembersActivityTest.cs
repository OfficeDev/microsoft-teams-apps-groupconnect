...
namespace Microsoft.Teams.Apps.DIConnect.Prep.Func.Test.PreparingToSend.Activities
{
    using System;
    ...
    public class SyncGroupMembersActivityTest
    {
        ...
        public async Task SyncGroupMembersActivitySuccessTest()
        {
            ...
            this.groupMembersService.Verify(x => x.GetGroupMembersAsync(It.Is<string>(x => x.Equals(groupId))), Times.Once());
        }

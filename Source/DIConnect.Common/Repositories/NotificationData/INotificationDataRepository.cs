// <copyright file="INotificationDataRepository.cs" company="Microsoft Corporation">
...
namespace Microsoft.Teams.Apps.DIConnect.Common.Repositories.NotificationData
{
    ...
    public interface INotificationDataRepository : IRepository<NotificationDataEntity>
    {
        ...
        public Task DuplicateDraftNotificationAsync(NotificationDataEntity notificationEntity, string createdBy);
        ...
        public Task SaveExceptionInNotificationDataEntityAsync(string notificationDataEntityId, string errorMessage);
        ...
        /// <returns>A <see cref="Task"/> representing the result of the asynchronous operation.</returns>
        public Task SaveWarningInNotificationDataEntityAsync(string notificationDataEntityId, string warningMessage);
    }
}
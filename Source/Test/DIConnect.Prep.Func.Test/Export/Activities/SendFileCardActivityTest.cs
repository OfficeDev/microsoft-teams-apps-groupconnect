...
namespace Microsoft.Teams.Apps.DIConnect.Prep.Func.Test.Export.Activities
{
    using System;
    ...
    public class SendFileCardActivityTest
    {
        ...
        private readonly Mock<IDIBotFrameworkHttpAdapter> botAdapter = new Mock<IDIBotFrameworkHttpAdapter>();

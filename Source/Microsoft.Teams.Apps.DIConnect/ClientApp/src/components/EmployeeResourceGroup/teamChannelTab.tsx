...
class TeamChannelTab extends React.Component<WithTranslation, ITeamChannelTabState> {
    ...
    constructor(props: any) {
        ...
        this.state = {
            loading: true,
            resourceGroup: { groupType: "", groupId: "", groupName: "", groupDescription: "", groupLink: "", imageLink: "", tags: [], location: "", includeInSearchResults: false, matchingFrequency: 0, isProfileMatchingEnabled: false },
        }
    }
        ...
        if (this.state.loading) {
            ...
            return (
                <div className="grp-container">
                    ...
                    {this.isTeamOwner && <Flex className="save-button" vAlign="end" hAlign="end" gap="gap.medium">

// <copyright file="SendFunction.cs" company="Microsoft Corporation">
...
namespace Microsoft.Teams.Apps.DIConnect.Send.Func
{
    ...
    using Microsoft.Teams.Apps.DIConnect.Send.Func.Services;
    ...
    public class SendFunction
    {
            ...
            ExecutionContext context)
        {
            ...
            {
                // Bad message shouldn't be re-queued.
        ...
        /// <summary>
        /// Get the message activity while user send message from bot.
        /// </summary>
        /// <param name="message">Message sent from bot.</param>
        /// <returns>Return adaptive card as attachment.</returns>

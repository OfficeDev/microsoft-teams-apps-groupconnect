    ...
    private handleSubmit = () => {
        if (this.checkIfSubmitAllowed()) {
            ...
            let groupDetails: EmployeeResourceGroupUpdate = {
                ...
                groupName: this.state.groupType === GroupType.external ? this.state.groupName : this.state.teamName,
                groupDescription: this.state.groupType === GroupType.external ? this.state.groupDescription : this.state.teamDescription,
                groupLink: this.state.groupType === GroupType.external ? this.state.groupLink : this.state.teamLink,

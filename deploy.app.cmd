...
call :ExecuteCmd dotnet publish "%DEPLOYMENT_SOURCE%\Source\DIConnect\Microsoft.Teams.Apps.DIConnect.csproj" --output "%DEPLOYMENT_TEMP%" --configuration Release -property:KuduDeployment=1
IF !ERRORLEVEL! NEQ 0 goto error

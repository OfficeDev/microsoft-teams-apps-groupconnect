...
export default class Constants {
    ...
    public static readonly maxLengthType: number = 50;
    ...
    public static readonly resourceTaskModuleHeight: number = 500;
    public static readonly resourceTaskModuleWidth: number = 580;
    public static readonly faqSettingsTaskModuleHeight: number = 460;
    public static readonly faqSettingsTaskModuleWidth: number = 600;

// <copyright file="GroupsService.cs" company="Microsoft Corporation">
...
namespace Microsoft.Teams.Apps.DIConnect.Common.Services.MicrosoftGraph
{
    ...
    internal class GroupsService : IGroupsService
    {
        ...
        public async Task<ISet<string>> GetTeamOwnersAadObjectIdAsync(string groupId)
        {
        ...
        public async Task<Group> GetTeamsInfoAsync(string groupId)
        {
        ...
        /// <summary>
        /// Search M365 groups, distribution groups, security groups based on query and visibility.
        /// </summary>
        /// <param name="query">query param.</param>

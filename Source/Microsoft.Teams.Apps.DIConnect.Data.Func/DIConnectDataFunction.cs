// <copyright file="DIConnectDataFunction.cs" company="Microsoft Corporation">
...
namespace Microsoft.Teams.Apps.DIConnect.Data.Func
{
    ...
    /// </summary>
    public class DIConnectDataFunction
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DIConnectDataFunction"/> class.
        /// </summary>
        ...
        [FunctionName("DIConnectDataFunction")]
            ...
            if (!notificationDataEntity.IsCompleted())
            {
                ...
                if (!notificationDataEntityUpdate.IsCompleted())
                {
                    ...
                    var dataQueueTriggerMessageDelayInSeconds =
                        DateTime.UtcNow <= notificationDataEntity.SendingStartedDate + TimeSpan.FromMinutes(DIConnectDataFunction.TenMinutes)
                            ? this.firstTenMinutesRequeueMessageDelayInSeconds
                            : this.requeueMessageDelayInSeconds;

...
[assembly: Microsoft.Azure.Functions.Extensions.DependencyInjection.FunctionsStartup(
    typeof(Microsoft.Teams.Apps.DIConnect.Send.Func.Startup))]
    ...
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddOptions<SendFunctionOptions>()
                .Configure<IConfiguration>((diConnectSendFunctionOptions, configuration) =>
                {
                    diConnectSendFunctionOptions.MaxNumberOfAttempts =
                        configuration.GetValue<int>("MaxNumberOfAttempts", 1);

                    diConnectSendFunctionOptions.SendRetryDelayNumberOfSeconds =
